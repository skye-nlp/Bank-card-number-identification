...
if __name__ == '__main__':
    ...
    if os.path.exists('/media/linux/hard/liuyapeng/CHINESE_OCR/crnn_ocr/pretrain-models/keras.hdf5'):
        basemodel.load_weights('/media/linux/hard/liuyapeng/CHINESE_OCR/crnn_ocr/pretrain-models/keras.hdf5')
