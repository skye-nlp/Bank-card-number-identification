 ...
 *     cdef int boxes_num = dets.shape[0]
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_4ctpn_3lib_5utils_7gpu_nms_1gpu_nms, NULL, __pyx_n_s_ctpn_lib_utils_gpu_nms); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 15, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
